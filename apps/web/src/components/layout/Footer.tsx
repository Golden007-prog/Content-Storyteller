  ...
  return (
    <footer className="bg-navy-900 text-white mt-auto">
      ...
      <div className="border-t border-white/10">
        <div className="section-wrapper py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm font-semibold">Content Storyteller</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Twitter */}
            <button className="text-gray-500 hover:text-white transition-colors" aria-label="Twitter">
            ...
            {/* Instagram */}
            <button className="text-gray-500 hover:text-white transition-colors" aria-label="Instagram">
        ...
        <div className="section-wrapper pb-6">
          <p className="text-xs text-gray-600 text-center">
            © 2024 Content Storyteller. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
